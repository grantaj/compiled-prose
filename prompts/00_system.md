...
- In the core publication stages, preserve exhaustive conceptual coverage unless the selected target explicitly authorises summarisation, compression, selective omission, or presentation reordering; when such permission exists, reduce coverage only as the target authorises and never in a way that makes retained material false, materially stronger or weaker, misleading, or detached from a necessary qualification or dependency
