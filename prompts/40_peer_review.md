...
- Judge the artefact as writing by the normal standards of the selected target, as though it had been submitted directly as a finished work of that target. Form this judgement without using fidelity, source coverage, traceability, or preservation of source structure as positive evidence of quality.
...
- SOURCE: adequate correction requires an authorial choice, new source material, or a change to the source's conceptual content, scope, reasoning, evidence, attribution, epistemic stance, or other authored relationship. This includes failure of the target-independent source-assurance floor, source material genuinely missing for an explicit target requirement, or additional reasoning, warrant, evidence, content-bearing example, distinction, conceptual development, interpretation, or another authorial decision not supplied by the source.
...
- Fidelity is not evidence of writing quality. Fidelity alone can never justify PASS.
