...
- SOURCE: adequate correction requires an authorial choice, new source material, or a change to the source's conceptual content, scope, reasoning, evidence, attribution, epistemic stance, or other authored relationship. This includes failure of the target-independent source-assurance floor, or additional reasoning, warrant, evidence, content-bearing example, distinction, conceptual development, interpretation, or another authorial decision not supplied by the source.
