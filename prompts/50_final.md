...
- Treat section boundaries, headings, lists, and paragraph units in the derived stage input as revisable presentation choices rather than conceptual authority. Correct mechanical source-skeleton projection when peer review identifies it and the source plus target fully determine a faithful restructuring.
