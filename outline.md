...
- Applies where transmission, coordination, reproducibility, explanation, or argument dominates.
- Excludes any universal claim for writing where voice, linguistic discovery, aesthetic form, ambiguity, or expression is primary.
- Requires a meaningful distinction between conceptual content and particular linguistic realisation.

### I.2 Authorship question
...
### IV.1 Disciplinary function

- Academic genres are community-based conventions. [Hyland 2008]
- Recognition of successful texts partly depends on familiar disciplinary forms. [Hyland 2008]
- Specialist literacies participate in knowledge construction, professional standing, identity, legitimate participation. [Hyland 2012; Hyland 2013]
...
Derived limit case of IV.3 disciplinary-recognition premise.
...
- evidence/attribution defect: repair source/support;
- target/style defect: repair target contract;
...
- Conceptual defects are repaired in `outline.md`; the prose is then regenerated by recompilation.
...
- conceptual art supplies precedent for conception/execution separation;
- academic discourse shows that prose also has disciplinary/social functions;
...
Supports: genre as community convention; disciplinary forms in successful academic texts.
...
Supports: discourse and disciplinary identity; positioning, conformity, individuality, legitimate participation.
...
Supports: AI assistance does not transfer responsibility from human authors; disclosure required.

Limit: not a universal account of academic authorship.
